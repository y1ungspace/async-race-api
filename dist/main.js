...
/* harmony export */   "unlockButtons": () => (/* binding */ unlockButtons)
/* harmony export */ });
...
function disableButtons(elem) {
    const button = elem.parentNode;
    button.className = "car__button_disabled";
}
function unlockButtons(elem, elemClass) {
...
function loadCar() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        response.forEach((x) => {
            ...
            const flag = newCar.querySelector('.car__racing-flag');
...
/* harmony export */ });
const carIcon = `<svg version="1.2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 160" width="100" height="20">
...
/* harmony export */ });
/* harmony import */ var _winnersTable__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./winnersTable */ "./src/scripts/winnersTable.ts");
var __awaiter = (undefined && undefined.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }
...
function ifExists(id, time) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        setTimeout(_winnersTable__WEBPACK_IMPORTED_MODULE_0__.loadTable, 5000);
    });
}
...
/* harmony export */ });
/* harmony import */ var _icon__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./icon */ "./src/scripts/icon.ts");
var __awaiter = (undefined && undefined.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }
...
let currentPage = 1;
function mergeInfos(sort = 'id', order = 'ASC', page = 1, limit = 10) {
    return __awaiter(this, void 0, void 0, function* () {
        const arrOfWinners = [];
        const winners = yield fetch(`http://127.0.0.1:3000/winners?_sort=${sort}&_order=${order}&_page=${page}&_limit=${limit}`)
            .then((response) => response.json())
            .then((result) => {
            return result;
        });
        const cars = yield fetch(`http://127.0.0.1:3000/garage`)
            .then((response) => response.json())
            .then((result) => {
            return result;
        });
        winners.forEach((x) => {
            const y = cars.find((elem) => elem.id === x.id);
            x.name = y.name;
            x.color = y.color;
            arrOfWinners.push(x);
        });
...
function loadTable(sort, order, page) {
    return __awaiter(this, void 0, void 0, function* () {
        let items = yield mergeInfos();
        if (sort) {
            items = (yield mergeInfos(sort, order, page));
        }
        let position = 1;
        tbody.innerHTML = '';
        items.forEach(elem => {
            ...
            tablePosition.textContent = position;
            name.textContent = elem.name;
            wins.textContent = elem.wins;
            bestTime.textContent = elem.time + 's';
            icon.innerHTML = _icon__WEBPACK_IMPORTED_MODULE_0__.carIcon;
...
loadTable();
winsColomn === null || winsColomn === void 0 ? void 0 : winsColomn.addEventListener('click', () => {
    timeSort = 'false';
...
timeColomn === null || timeColomn === void 0 ? void 0 : timeColomn.addEventListener('click', () => {
    winsSort = 'false';
    winsColomn.innerHTML = 'Wins';
    currentState = 'time';
    if (timeSort === 'false') {
...
/***/ "./src/assets/car-02.svg":
/*!*******************************!*\
  !*** ./src/assets/car-02.svg ***!
  \*******************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

module.exports = __webpack_require__.p + "./assets/car-02..svg";
...
/***/ "./src/assets/racing-flag.png":
/*!************************************!*\
  !*** ./src/assets/racing-flag.png ***!
  \************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

module.exports = __webpack_require__.p + "./assets/racing-flag..png";
